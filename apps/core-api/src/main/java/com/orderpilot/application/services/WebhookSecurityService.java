...
public class WebhookSecurityService {
  ...
  public boolean isReplay(String provider, String externalEventId){ return externalEventId != null && !externalEventId.isBlank() && repository.existsByProviderAndExternalEventId(provider, externalEventId); }
}
...
public final class Stage7Dtos {
  ...
  public record BotResponseDraftResponse(UUID id, UUID conversationId, UUID sourceMessageId, String channel, String responseType, String policyDecision, String status, String responseText, boolean requiresOperatorReview, Instant reviewedAt, Instant stubSentAt, Instant createdAt, Instant updatedAt) {}

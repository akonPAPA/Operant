...
public class WorkspaceController {
  ...
  @PostMapping("/notes") public WorkspaceNote addNote(@RequestBody NoteRequest request, HttpServletRequest http){return noteService.add(request.targetType(), request.targetId(), request.noteText(), trustedActor(http));}

...
public class UomNormalizationResult {
  ...
  public void correct(String normalizedUom, Instant now){this.normalizedUom=normalizedUom;this.status="CORRECTED";this.confidence=BigDecimal.ONE;this.updatedAt=now;} public UUID getId(){return id;} public UUID getExtractedLineItemId(){return extractedLineItemId;} public String getRawUom(){return rawUom;} public String getNormalizedUom(){return normalizedUom;} public String getStatus(){return status;} public BigDecimal getConfidence(){return confidence;}
}
